    ...
    <div className="bg-tiko-surface-container-low rounded-2xl p-6 space-y-5 sticky top-24">
      ...
      <div className="flex justify-between font-bold text-tiko-on-surface text-base pt-2 border-t border-tiko-outline-variant">
        ...
        <span className="text-tiko-primary font-outfit">
          {(total + deliveryFee).toFixed(2)} JOD
        </span>
      </div>
              ...
              <div className="bg-white border border-tiko-outline-variant rounded-2xl p-6 sm:p-8 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
                  ...
                  <div className="bg-tiko-surface-container-low border border-tiko-outline-variant rounded-xl px-4 py-3 flex items-center gap-3 mt-6 sm:mt-0 self-end">
                    <svg
                      className="text-tiko-primary shrink-0"
                      width="18"
                      height="18"
                      viewBox="0 0 24 24"
                      fill="none"
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-tiko-on-surface-variant uppercase tracking-wider">
                        Estimated Arrival
                      </p>
                      <p className="text-sm font-bold text-tiko-on-surface">
              ...
              <div className="bg-white border border-tiko-outline-variant rounded-2xl p-6 sm:p-8 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    <span
                      className={`text-sm font-outfit font-bold ${selectedPayment === "card" ? "text-tiko-primary" : "text-tiko-on-surface-variant"}`}>
                      Credit / Debit Card
                    </span>
                  </button>
                  ...
                  <button
                    ...
                    <span
                      className={`text-sm font-outfit font-bold ${selectedPayment === "cod" ? "text-tiko-primary" : "text-tiko-on-surface-variant"}`}>
                      Cash on Delivery
                    </span>
                  </button>
                </div>
